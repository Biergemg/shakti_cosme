...
export function Footer({
  ...
  return (
    <footer className="border-t border-[var(--color-border-soft)] bg-[var(--color-page)] py-12">
      <Shell>
        <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr_0.9fr] lg:gap-12">
          ...
          <div className="space-y-4 text-sm leading-7 text-[var(--color-text-muted)]">
            ...
            <a href={site.phoneHref} className="flex items-center gap-2 transition hover:text-[var(--color-brand-strong)]">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex items-center gap-2 transition hover:text-[var(--color-brand-strong)]"
            >
